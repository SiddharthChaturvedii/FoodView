    ...
    return (
        <nav className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between px-6 md:px-12 py-4 bg-transparent">
            ...
            <div className="flex items-center gap-3 md:gap-5">
                ...
                <Link
                    to={profileLink}
                    className="flex items-center justify-center w-10 h-10 text-white bg-white/10 backdrop-blur-sm border border-white/20 rounded-full hover:bg-white/20 transition-all"
                    title="Profile"
                >
